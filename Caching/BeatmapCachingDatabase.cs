...
namespace SosuBot.PerformanceCalculator.Caching
{
    internal sealed class BeatmapCachingDatabase
    {
        #region Singleton
        public static BeatmapCachingDatabase Instance
        {
            get
            {
        ...
        private static Lazy<BeatmapCachingDatabase> _instance = new Lazy<BeatmapCachingDatabase>(() => new BeatmapCachingDatabase(), true);
        #endregion
        ...
        private BeatmapCachingDatabase(string? cacheDirectory = null)
        {
